package com.easycloud.oci.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select() 
				.apis(RequestHandlerSelectors.basePackage("com.easycloud.oci.resources"))
	...
	private ApiInfo apiInfo() { 
		return new ApiInfo(
				"Projeto Easy Cloud",
				"Esta API serão utilizadas no projeto Easy Cloud",
				"Versão 1.0",
				"http://www.leiparatodos-lei.com.br",
				new Contact("Silvio Cristiano & Leonardo Roque", "Easy Cloud", "sivuca1@gmail.com"), "Permitido uso para desenvolvedores desse projeto",
				"http://www.leiparatodos-lei.com.br",
